# ============================================================
# Extension 03: Good-overlap instability diagnostic
# ============================================================
# Standalone run:
#   source("extension_03_good_overlap_instability.R")
#
# This extension investigates whether near-constant observed ATT weights can
# create structural instability even when ordinary IPW overlap looks excellent.
# It runs an observed-strength by hidden-strength grid, a sample-size
# robustness grid, an epsilon-stabilizer grid, and enhanced plotting.
# ============================================================
...
dirs <- prepare_extension_dirs(.project_dir, "03_good_overlap_instability")
...
run_python_plot(
  project_dir = .project_dir,
  script_relative_path = "scripts/enhanced_plot_good_overlap_instability.py",
